...
function getFormInput(OUTPUT){
    ...
    OUTPUT.innerHTML += "<p>Welcome to my page, " + UserName.value + "</p>";
    OUTPUT.innerHTML += "<p>You are " + UserAge.value + " years old.</p>";
    OUTPUT.innerHTML += "<p>You have $" + UserMoney.value + ".</p>";
}
